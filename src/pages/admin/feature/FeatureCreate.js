    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col">
          ...
          {loaded && !loading && <h4>Create Feature</h4>}
          <FeatureForm
          ...
          {loaded && (
            <>
              ...
              {/* step 5 */}
              {Features.filter(searched(keyword)).map((c) => (
